...
class RecorderHome6 extends StatefulWidget {
  final String text1;
  final String text2;

  const RecorderHome6({Key? key, required this.text1, required this.text2})
      : super(key: key);
  @override
  _RecorderHome6State createState() => _RecorderHome6State();
}

class _RecorderHome6State extends State<RecorderHome6> {
  @override
