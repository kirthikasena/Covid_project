...
export default class Recordaudio extends  React.Component {
  ...
  render() {
    ...
    const handleRedirect =async (e) =>{
      console.log("ok")
       window.location.href = '/Fastcounting';
    }
    ...
    const handleSubmit = async (e) => {
      ...
      try {
              ...
              fetch('http://127.0.0.1:5000/vowel_O', {
                method: 'POST',
                body: data
    ...
    return (
      <div class="chbackground">
        ...
        <h1 class="ch1line1">Record VOWEL "O" sound for 4 seconds</h1>
        ...
        backgroundColor="#FFFFFF"></AudioAnalyser></div>
            ...
            <Link to="/Fastcounting"><button className="rebtn4" onClick={handleSubmit}><b/>Upload</button></Link>
          </div>
