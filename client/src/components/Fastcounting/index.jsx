...
import  styles from "./fastcounting.css";
  ...
  render() {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
              ...
              fetch('http://127.0.0.1:5000/fast_counting', {
                method: 'POST',
                body: data
    ...
    return (
      <div class="chbackground">
        ...
        <h1 class="ch1line1">Record your FAST COUNTING for 4 seconds</h1>
        ...
        backgroundColor="#FFFFFF"></AudioAnalyser></div>
            ...
            <Link to="/Results1"><button className="rebtn4" onClick={handleSubmit}><b/>Upload</button></Link>
          </div>
