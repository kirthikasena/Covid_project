...
import  styles from "./shallowcough.css";
...
export default class Shallowcough extends  React.Component {
  constructor(props) {
    super(props);
    this.state = {
      status: ""
  ...
  render() {
    ...
    const handleRedirect =async (e) =>{
      console.log("ok")
       window.location.href = '/Heavycough';
    }
    ...
    const handleSubmit = async (e) => {
      ...
      try {
              ...
              fetch('http://127.0.0.1:5000/shallow_cough', {
                method: 'POST',
                body: data
    ...
    return (
      <div class="chbackground">
        ...
        <h1 class="ch1line1">Record your SHALLOW COUGH for 4 seconds</h1>
        ...
        backgroundColor="#FFFFFF"></AudioAnalyser></div>
            ...
            <Link to="/Heavycough"><button className="rebtn4" onClick={handleSubmit}><b/>Upload</button></Link>
          </div>
