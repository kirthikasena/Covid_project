...
import  "./checkcough3.css";
import MicRecorder from 'mic-recorder-to-mp3';
import im2 from "../../images/im2.png";
import { Link, useNavigate } from "react-router-dom";
const Mp3Recorder = new MicRecorder({ bitRate: 128 });

class Checkcough3 extends React.Component {
  ...
  render() {
    return (
      <div class="chbackground">
        ...
        <h1 class="ch3line1">Record your heavy cough for 4 seconds</h1>
        ...
        /></div>
          ...
          <Link to="/Checkcough4"><button class="chbtn3"><b>Next</b></button></Link>
